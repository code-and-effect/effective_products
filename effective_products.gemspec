...
Gem::Specification.new do |spec|
  spec.name        = 'effective_products'
  spec.version     = EffectiveProducts::VERSION
  spec.authors     = ['Code and Effect']
  spec.email       = ['info@codeandeffect.com']
  spec.homepage    = 'https://github.com/code-and-effect/effective_products'
  spec.summary     = 'Highly customized product sales for member associations'
  spec.description = 'Highly customized product sales for member associations'
  spec.license     = 'MIT'
